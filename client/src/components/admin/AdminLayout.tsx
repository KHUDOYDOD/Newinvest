...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const menuItems = [
    ...
    { 
      ...
      href: "/admin/behavior", 
      active: location === "/admin/behavior",
      badge: "New",
      description: "Анализ пользовательского поведения"
    },
    { 
      ...
      badge: null,
      description: "Детальная финансовая аналитика"
    },
    { 
      icon: <GanttChartSquare size={20} />, 
      label: "Планирование", 
      href: "/admin/planning", 
      active: location === "/admin/planning",
      badge: null,
    ...
    { 
      ...
      badge: "5",
      description: "Управление коммуникациями"
    },
    { 
      icon: <Users size={20} />, 
    ...
    { 
      ...
      href: "/admin/system", 
      active: location === "/admin/system",
      badge: null
    },
    { 
      icon: <BarChartHorizontal size={20} />, 
      label: "Генератор отчетов", 
      href: "/admin/reports", 
